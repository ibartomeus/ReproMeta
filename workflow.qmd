...
## Make the document visible on github 

-   In GitHub go to `Settings/Pages` and enable webpage creation.

-   Many options are possible, but a simple `Deploy from branch`, main in `/doc` should work.

-   GitHub will look for a `index.html` and a `.nojekyll` file.

-   Link it to the GitHub "About" section in the right column.
